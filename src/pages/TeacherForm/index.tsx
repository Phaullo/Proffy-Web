    ...
    return (
        <div id="page-teacher-form" className="container">
            <PageHeader 
                ...
                description="O primeiro passo é preecher esse forumário de inscrição"
            />
            ...
            <main>
                ...
                {scheduleItems.map((scItem, index)=>{
                    return (
                        <div key={scItem.week_day} className="schedule-item">
                        <Select 
                           name="week_day" 
                           label="Dia da Semana" 
                       ...
                       <Input 
                            name="from" label="Das" type="time" value={scItem.from}
                            onChange={e => setScheduleItemValue(index, 'from', e.target.value)}

                       />

                       <Input 
                            name="to" label="Até" type="time" value={scItem.to}
